...
public:
    Sphere(const Vector3D& position, const double radius, const Vector3D& orientation = Vector3D({0.0, 0.0, 1.0}), const Vector3D& reference_direction = Vector3D({0.0, 0.0, 0.0}));
